use axum::{Server, Router, routing::get, response::{Html, IntoResponse}, extract::{State, WebSocketUpgrade, ws::{WebSocket, Message}}, http::Response};
...
async fn main() {
	...
	let router = Router::new()
		...
		.route("/ws/cpus", get(realtime_cpus_get))
